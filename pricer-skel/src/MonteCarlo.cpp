...
void MonteCarlo::price(const PnlMat *past, double t, double &prix, double &std_dev) {
    ...
    prix =  sumpayoff*exp(- this->mod_->r_ * (this->opt_->T_ - t)) / this->nbSamples_;
    sigma = squaresum / this->nbSamples_ - (sumpayoff / this->nbSamples_)*(sumpayoff / this->nbSamples_);
